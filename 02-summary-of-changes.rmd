...
To highlight changes that could affect interpretation of the groundfish data, we extracted data from the GFBio database for 1975--2022 [@databases2023].
...
```{r trawl-overlap, fig.cap="(ref:trawl-overlap)"}
...
The most notable change to catch sorting and sampling occurred from 2001 to 2003. 
From 2001--present the entire catch was sorted wherever possible and from 2003--present all species were sorted and identified to the species or to the lowest taxonomic level possible [@rutherfordinprep].
For large volumes of catch, or catches with a large number of small organisms, the total catch was sub-sampled and the total catch was visually estimated or weighed.
...
To check if some species were identified at higher taxonomic levels prior to 2003, we extracted data from GFBio for higher order taxonomies of species observed in the SMMS survey since 2003.
...
In ten years, some rockfish were recorded at a higher taxonomic level, the total recorded biomass was < 0.1\%, except for in 2019 (6.7\% of total catch) and 2021 (1.6% of total catch) (\@ref(fig:spp-aggregate-plot)). 
